...
public class DemoConfigPanel extends JPanel implements ActionListener {
	...
	private JCheckBox cb = new JCheckBox("提示出错");
	private JCheckBox cbDrawLineHelp = new JCheckBox("划线辅助");
	private JButton btnReGenerate = new JButton("重新出题");
	private JButton btnAutoSolve = new JButton("给出答案");
	private JLabel label = new JLabel("难度系数:");
	...
	private void setSubPanelsSize() {
		...
		// this.assistantPanel.setSize(200, 200);
		// this.miscPanel.setSize(200, 200);
	...
	private void buildMiscPanel() {
		textFiledDifficulty.setToolTipText("请填入1-10之间的数值");
